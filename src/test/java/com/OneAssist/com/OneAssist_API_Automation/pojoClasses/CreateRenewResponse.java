...
public class CreateRenewResponse implements Serializable
{
    ...
    private final static long serialVersionUID = -6270861422551806759L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public CreateRenewResponse() {
    }
     ...
     * @param paymentInfo
     */
    public CreateRenewResponse(List<CustomerDetail> customerDetails, PaymentInfo paymentInfo, OrderInfo orderInfo, String initiatingSystem, String userId, String membershipId) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreateRenewResponse) == false) {
            return false;
        }
        CreateRenewResponse rhs = ((CreateRenewResponse) other);

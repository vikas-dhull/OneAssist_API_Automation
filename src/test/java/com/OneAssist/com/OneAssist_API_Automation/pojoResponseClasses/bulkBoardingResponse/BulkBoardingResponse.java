...
public class BulkBoardingResponse implements Serializable
{
    ...
    private final static long serialVersionUID = 7173075156808533513L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public BulkBoardingResponse() {
    }
     ...
     * @param status
     */
    public BulkBoardingResponse(String payNowLink, String isMotoPayment, String paymentMode, String isMailSent, CustomerOrderInfo customerOrderInfo, MembershipInfo membershipInfo, List<PendingCustomerInfo> pendingCustomerInfo, List<ProductInfo> productInfo, String primaryCustomerName, Object secondaryCustomerName, String status, String message) {
        super();
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(payNowLink).append(isMotoPayment).append(paymentMode).append(isMailSent).append(customerOrderInfo).append(membershipInfo).append(pendingCustomerInfo).append(productInfo).append(primaryCustomerName).append(secondaryCustomerName).append(status).append(message).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BulkBoardingResponse) == false) {
            return false;
        }
        BulkBoardingResponse rhs = ((BulkBoardingResponse) other);
